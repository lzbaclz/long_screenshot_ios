...
正式源码已落地，新增明确候选来源与 padding 带外保护；第二道闸和诊断字段均已实现。原生 81 / 81（新增 Header 7 项）、核心 76 / 76、基准 217 / 217、新固定栏真实手势 3 / 3、原壁纸 3 / 3、保存／分享 1 / 1 全部通过。完整记录与验证边界见 [0.1.4 更新记录](release/0.1.4-testflight.md)。0.1.4（5）已于 2026-09-15 00:49:19 手动上传，处理完成并加入原内部组，状态确认“正在测试”；详见更新记录。
